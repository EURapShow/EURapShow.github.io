...
{var registry=IWCreateEffectRegistry();registry.registerEffects({stroke_0:new IWEmptyStroke(),stroke_1:new IWStrokeParts([{rect:new IWRect(-1,1,2,54),url:'EU_Rap_Show___Playlist___EURapShow_files/stroke.png'},{rect:new IWRect(-1,-1,2,2),url:'EU_Rap_Show___Playlist___EURapShow_files/stroke_1.png'},{rect:new IWRect(1,-1,657,2),url:'EU_Rap_Show___Playlist___EURapShow_files/stroke_2.png'},{rect:new IWRect(658,-1,2,2),url:'EU_Rap_Show___Playlist___EURapShow_files/stroke_3.png'},{rect:new IWRect(658,1,2,54),url:'EU_Rap_Show___Playlist___EURapShow_files/stroke_4.png'},{rect:new IWRect(658,55,2,2),url:'EU_Rap_Show___Playlist___EURapShow_files/stroke_5.png'},{rect:new IWRect(1,55,657,2),url:'EU_Rap_Show___Playlist___EURapShow_files/stroke_6.png'},{rect:new IWRect(-1,55,2,2),url:'EU_Rap_Show___Playlist___EURapShow_files/stroke_7.png'}],new IWSize(659,56))});registry.applyEffects();}
function hostedOnDM()
{return false;}
function onPageLoad()
